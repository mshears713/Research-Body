...
st.subheader("*Explore the Organism's Memory*")

st.markdown("---")

st.markdown("""
## The Organism's Memory Bank

Every mission the research organism executes is recorded in its **memory** — the
SQLite database maintained by the Logger Tool. This chapter lets you explore
that history:

- 📊 **Performance Analytics:** How efficient is the organism?
- 🔍 **Mission Details:** What happened in each mission?
- 📈 **Trends Over Time:** Is the system improving?
- 🏥 **Organ Health:** How are individual organs performing?

This is where you learn from the organism's past to improve its future.
""")
