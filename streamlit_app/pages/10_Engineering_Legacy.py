...
# Custom CSS for organism theme - DNA/Evolution Theme
st.markdown("""
<style>
    /* Evolution/DNA Theme - Vibrant Greens and Teals */
    .stApp {
        background: linear-gradient(135deg, #e8f5e9 0%, #f1f8e9 100%);
    }

    /* DNA Helix Inspired Cards */
    .legacy-card {
...
# Header with DNA/Evolution theme
st.markdown("""
<div style='text-align: center; padding: 2rem; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border-radius: 15px; margin-bottom: 2rem;'>
    <h1 style='color: white; margin: 0; text-shadow: 0 0 20px rgba(255,255,255,0.3);'>🧬 Engineering Legacy</h1>
    <p style='color: #e8f5e9; font-size: 1.2rem; margin-top: 0.5rem;'>The Evolution of the Research Organism</p>
</div>
""", unsafe_allow_html=True)

st.markdown("---")

# Opening narrative with organism evolution theme
st.markdown("""
## 🌱 The Journey: From Simple Tools to Living Intelligence

Over the course of this project, we've witnessed the **birth and evolution** of a complete
"research organism" — a living system that demonstrates the critical distinction between
**passive tools** and **autonomous agents**.

<div style='background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); padding: 1.5rem; border-radius: 10px; margin: 1rem 0;'>

### 🧬 This Final Chapter Chronicles:

- 🏗️ **What We've Built** — The complete organism and its organs
- 🔄 **The Evolution** — From tools to agents (Phase 5 transformation)
- 🚀 **Future Horizons** — Extensions and possibilities ahead
- 📚 **Engineering Wisdom** — Principles learned through creation
- 🌟 **The Living Legacy** — How this organism can grow and adapt

</div>

**Core Philosophy:** Just as biological organisms evolved from simple cells to complex systems,
our research body evolved from deterministic tools to intelligent, adaptive agents.
""", unsafe_allow_html=True)
